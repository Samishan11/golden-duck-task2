          ...
          <div className={Style.solutionDetails}>
            ...
            <div className={Style.solutionDetailsContent}>
              <div className={Style.solutionList}>
                ...
                <ul>
                  <li>
                    <MdOutlineDone /> Responsive Website
                  </li>
                  <li>
                    <MdOutlineDone /> Search Engine Friendly
                  </li>
                  <li>
                    <MdOutlineDone /> Content Management System
                  </li>
                  <li>
                    <MdOutlineDone />
          ...
          <div className={Style.solutionDetails}>
            ...
            <div className={Style.solutionDetailsContent}>
              <div className={Style.solutionList}>
                ...
                <ul>
                  <li>
                    <MdOutlineDone /> Logo and Branding Design
                  </li>
                  <li>
                    <MdOutlineDone /> Social Media Design
                  </li>
                  <li>
                    <MdOutlineDone /> Infographics/Print Design
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={Style.solutionDetails}>
            ...
            <div className={Style.solutionDetailsContent}>
              <div className={Style.solutionList}>
                ...
                <ul>
                  <li>
                    <MdOutlineDone /> Search Engine Optimization
                  </li>
                  <li>
                    <MdOutlineDone /> Social Media Marketing
                  </li>
                  <li>
                    <MdOutlineDone /> Email Marketing
                  </li>
                </ul>
              </div>
            </div>
