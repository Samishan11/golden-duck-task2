                    ...
                    <div className={Style.work}>
                        <div className={Style.step1}>
                            <div className={Style.text}>
                                ...
                                <p style={{ fontSize: "10px" }}>This is the first step of the development process.</p>
                            </div>
                        </div>
                        <img className={Style.arrowimg1} src="/assets/images/arrow.png" width={200} alt="arrow logo" />
                    </div>
                    <div className={Style.work}>
                        <div className={Style.step1}>
                            <div className={Style.text}>
                        ...
                        <img className={Style.arrowimg2} src="/assets/images/arrow.png" width={200} alt="arrow logo" />
                    </div>
                    <div className={Style.work}>
                        <div className={Style.step1}>
                            <div className={Style.text}>
                        ...
                        <img className={Style.arrowimg3} src="/assets/images/arrow.png" width={200} alt="arrow logo" />
                    </div>
                    <div className={Style.work}>
                        <div className={Style.step1}>
                            <div className={Style.text}>
                        ...
                        <img className={Style.arrowimg4} src="/assets/images/arrow.png" width={200} alt="arrow logo" />
                    </div>
                </div>
            </div>
        </div>
